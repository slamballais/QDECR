...
## Bug fixes
* [#59](https://github.com/slamballais/QDECR/pull/59): Added a check to make sure that the supplied `formula` is of class `formula` (addresses [#54](https://github.com/slamballais/QDECR/issues/54)).
...
* [#61](https://github.com/slamballais/QDECR/pull/61): I made an attempt to fix the bug with `custom_measure`. Not sure whether it is actually fixed (addresses [#57](https://github.com/slamballais/QDECR/issues/57)).
