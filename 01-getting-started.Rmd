...
* A Unix system. [see 1.2.1]
* [Freesurfer](https://surfer.nmr.mgh.harvard.edu/) installed. [see 1.2.2]
* Your images processed through Freesurfer with the `-qcache` flag. [see 1.2.3]
* [`R`](https://www.r-project.org) installed. [see 1.2.4]
* A lot of other `R` packages that will be installed automatically. [see 1.2.4 or 1.3]
* Make sure your target template (usually fsaverage) is in your `SUBJECTS_DIR` (directory with all your Freesurfer output). [see 1.2.5]

We also highly suggest:

* Set `FREESURFER_HOME` and `SUBJECTS_DIR`; both can be set manually in QDECR, but it is more convenient. [see 1.4.1]
* [`Magick++`](https://www.imagemagick.org/Magick++/STL.html); this is required for a specific plotting function (`qdecr_snap`) that you may or may not need. [see 1.2.6]
...
## 1.2.5 Target template in SUBJECTS_DIR
...
## 1.2.6 Suggestion: Install Magick++ and the R package `magick`
