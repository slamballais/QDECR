...
* Consider where you want to contribute:
  - **QDECR package**: Please branch off [the dev branch](https://github.com/slamballais/QDECR/tree/dev). This helps us control the release of minor and major changes.
  - **website**: Please branch off the [gh-pages branch](https://github.com/slamballais/QDECR/tree/gh-pages).
