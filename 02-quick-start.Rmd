...
## Obtain a Freeview plot for a specific stack/contrast
qdecr_snap(out, 2)
qdecr_snap(out, 'age') #same output

## Obtain cluster-wise location data
qdecr_cluster(out)

## Obtain Monte-Carlo simulation threshold maps for a contrast
qdecr_MCZ(out, 2, c(10, 13, 20, 23, 30))
